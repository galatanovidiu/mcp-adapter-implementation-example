            ...
            array(
                ...
                'input_schema'  => array(
                    ...
                    'properties' => array(
                        ...
                        'content' => array('type' => 'string', 'description' => 'Post content as HTML. Include WordPress block comments (<!-- wp:blockname {"attr":"value"} -->) for full block editor compatibility. Use wpmcp/list-block-types to get valid block names and attributes.'),
                        'excerpt' => array('type' => 'string'),
                        'status' => array('type' => 'string'),
                        'author' => array('type' => 'integer'),
                        'meta' => array('type' => 'object', 'additionalProperties' => true),
                        'tax_input' => array('type' => 'object', 'additionalProperties' => true),
                        'create_terms_if_missing' => array('type' => 'boolean', 'default' => false),
                        'append_terms' => array('type' => 'boolean', 'default' => true),
                    ),
                ),
                'output_schema' => array(
                    'type'       => 'object',
