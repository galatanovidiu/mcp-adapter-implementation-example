...
final class ListPosts implements RegistersAbility
{
    public static function register(): void
    {
        ...
        $available_post_statuses = array_keys(\get_post_stati(array('public' => true, 'private' => true)));
            ...
            array(
                ...
                'output_schema' => array(
                    ...
                    'properties' => array(
                        ...
                        'total'       => array('type' => 'integer', 'description' => 'Number of posts returned in this request'),
                        'found_posts' => array('type' => 'integer', 'description' => 'Total number of posts matching the query'),
                        'max_pages'   => array('type' => 'integer', 'description' => 'Maximum number of pages available'),
                    ),
                ),
