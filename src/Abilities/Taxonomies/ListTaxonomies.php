        ...
        \wp_register_ability(
            ...
            array(
                ...
                'input_schema'  => array(
                    'type'       => 'object',
                    'properties' => array(
                        'post_type' => array('type' => 'string', 'description' => 'Optional post type to filter taxonomies supported.'),
                        'include_private' => array('type' => 'boolean', 'default' => false),
                        'only_show_in_rest' => array('type' => 'boolean', 'default' => true),
                    ),
                ),
                'output_schema' => array(
                    'type'       => 'object',
                ...
                'execute_callback'    => static function (array $input) {
                    ...
                    foreach ($tax_objects as $tax) {
                        ...
                        $out[] = array(
                            'name'         => $name,
                            'label'        => isset($tax->label) ? (string) $tax->label : $name,
